...
class ResNeSt101(Algorithm):
    ...
    def _build_net(self) -> nn.Module:
        ...
        resnest101.fc = nn.Linear(in_features=resnest101.fc.in_features, out_features=self.num_classes)

        # list(resnest101.children()) consists of following modules
