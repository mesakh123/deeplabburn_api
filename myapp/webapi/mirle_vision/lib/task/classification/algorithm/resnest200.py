...
class ResNeSt200(Algorithm):
    ...
    def _build_net(self) -> nn.Module:
        ...
        resnest200.fc = nn.Linear(in_features=resnest200.fc.in_features, out_features=self.num_classes)

        # list(resnest200.children()) consists of following modules
