...
class ResNet34(Algorithm):
    ...
    def _build_net(self) -> nn.Module:
        ...
        resnet34.fc = nn.Linear(in_features=resnet34.fc.in_features, out_features=self.num_classes)

        # list(resnet34.children()) consists of following modules
