...
class Evaluator:
    ...
    def _evaluate(self, prediction: Prediction) -> Evaluation:
        ...
        mean_sensitivity = sum([v for _, v in class_to_sensitivity_dict.items()]) / len(class_to_sensitivity_dict)
        mean_specificity = sum([v for _, v in class_to_specificity_dict.items()]) / len(class_to_specificity_dict)
        ...
        evaluation = Evaluator.Evaluation(
            ...
            metric_sensitivity=Evaluator.Evaluation.MetricResult(mean_sensitivity, class_to_sensitivity_dict),
            metric_specificity=Evaluator.Evaluation.MetricResult(mean_specificity, class_to_specificity_dict)
        )
        return evaluation
