...
class ResNeXt101_32x8d(Backbone):
    ...
    def _build_component(self) -> Backbone.Component:
        resnext101_32x8d = torchvision.models.resnext101_32x8d(pretrained=self.pretrained)

        # list(resnext101_32x8d.children()) consists of following modules
