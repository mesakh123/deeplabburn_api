...
class ResNeXt50_32x4d(Backbone):
    ...
    def _build_component(self) -> Backbone.Component:
        resnext50_32x4d = torchvision.models.resnext50_32x4d(pretrained=self.pretrained)

        # list(resnext50_32x4d.children()) consists of following modules
