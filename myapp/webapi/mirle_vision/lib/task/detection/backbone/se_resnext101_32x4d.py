...
class SEResNeXt101_32x4d(Backbone):
    ...
    def _build_component(self) -> Backbone.Component:
        se_resnext101_32x4d = pretrainedmodels.__dict__['se_resnext101_32x4d'](num_classes=1000, pretrained='imagenet' if self.pretrained else None)

        # list(se_resnext101_32x4d.children()) consists of following modules
        #   [0] = Sequential(Conv2d...),
