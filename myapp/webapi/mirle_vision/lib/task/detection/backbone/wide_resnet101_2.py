...
class WideResNet101_2(Backbone):
    ...
    def _build_component(self) -> Backbone.Component:
        wide_resnet101_2 = torchvision.models.wide_resnet101_2(pretrained=self.pretrained)

        # list(wide_resnet101_2.children()) consists of following modules
