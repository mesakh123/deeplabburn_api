...
class Config(config.Config):
    ...
    roi_resized_width: int = 224
    roi_resized_height: int = 224
    ...
    def to_hyper_param_dict(self) -> Dict[str, Union[int, float, str, bool, Tensor]]:
        ...
        hyper_param_dict.update({
            ...
            'roi_resized_width': self.roi_resized_width,
            'roi_resized_height': self.roi_resized_height
        })
    ...
    def parse_config_dict(
            ...
            roi_resized_width: str = None, roi_resized_height: str = None
    ) -> Dict[str, Any]:
        ...
        if roi_resized_width is not None:
            config_dict['roi_resized_width'] = int(roi_resized_width)
        if roi_resized_height is not None:
            config_dict['roi_resized_height'] = int(roi_resized_height)
