...
class Checkpoint(Base):
    ...
    def save(checkpoint: 'Checkpoint', path_to_checkpoint: str):
        ...
        checkpoint_dict = {
            ...
            'algorithm_params': {
                'image_min_side': algorithm.image_min_side,
                'image_max_side': algorithm.image_max_side
            }
        }
    ...
    def load(path_to_checkpoint: str, device: torch.device) -> 'Checkpoint':
        ...
        algorithm: Algorithm = algorithm_class(
            num_classes,
            image_min_side=algorithm_params['image_min_side'],
            image_max_side=algorithm_params['image_max_side']
        )
